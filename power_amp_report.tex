...
\title{ IO/IO Ring Placement and EMIR Analysis-- OBSOLETE Power Amplifier - SiFlower cn} % Title of the assignment
...
\section*{Introduction - IO/IO ring} % Unnumbered section
...
%----------------------------------------------------------------------------------------
%	Isolation, noise analysis for the whole chip
%----------------------------------------------------------------------------------------
